...
<div class="mx-auto max-w-7xl p-4 sm:p-6">
	...
	{:else if tradeStore.trades.length === 0}
		...
		<div class="rounded-lg border p-12 text-center">
			<p class="mb-4 text-muted-foreground">No flips yet. Start your first flip!</p>
				...
				{#each tradeStore.trades as plan (plan.id)}
					...
					>
						<div class="flex items-center gap-3">
							...
							<!-- Buy info -->
							<span class="text-sm text-muted-foreground">Buy</span>
							...
							<!-- Sell side -->
							<span class="ml-2 text-sm text-muted-foreground">Sell @</span>
							...
							{:else if plan.sellPrice != null && plan.sellPrice > 0}
								...
								<span class="text-sm font-medium text-blue-500 italic">
